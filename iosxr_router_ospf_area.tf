    ...
    for device in local.devices : [
      for ospf_process in try(local.device_config[device.name].routing.ospf_processes, []) : [
        for area in try(ospf_process.areas, []) : {
          key                                                             = format("%s/%s/%s", device.name, ospf_process.id, area.id)
          device_name                                                     = device.name
          process_name                                                    = try(ospf_process.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.id, null)
          area_id                                                         = try(area.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.id, null)
          ...
          mpls_ldp_sync                                                   = try(area.mpls_ldp_sync, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.mpls_ldp_sync, null) == "enable" ? true : null
          mpls_ldp_sync_disable                                           = try(area.mpls_ldp_sync, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.mpls_ldp_sync, null) == "disable" ? true : null
          mpls_ldp_sync_igp_shortcuts                                     = try(area.mpls_ldp_sync_igp_shortcuts, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.mpls_ldp_sync_igp_shortcuts, null) == "enable" ? true : null
          mpls_ldp_sync_igp_shortcuts_disable                             = try(area.mpls_ldp_sync_igp_shortcuts, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.mpls_ldp_sync_igp_shortcuts, null) == "disable" ? true : null
          ...
          external_out_enable                                             = try(area.external_out, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.external_out, null) == "enable" ? true : null
          external_out_disable                                            = try(area.external_out, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.external_out, null) == "disable" ? true : null
          summary_in_enable                                               = try(area.summary_in, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.summary_in, null) == "enable" ? true : null
          summary_in_disable                                              = try(area.summary_in, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.summary_in, null) == "disable" ? true : null
          segment_routing_mpls                                            = try(area.segment_routing.mode, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.segment_routing.mode, null) == "mpls" ? true : null
          segment_routing_disable                                         = try(area.segment_routing.mode, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.segment_routing.mode, null) == "disable" ? true : null
          segment_routing_forwarding_mpls                                 = try(area.segment_routing.forwarding, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.segment_routing.forwarding, null) == "mpls" ? true : null
          segment_routing_forwarding_disable                              = try(area.segment_routing.forwarding, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.segment_routing.forwarding, null) == "disable" ? true : null
          ...
          authentication_key_encrypted                                    = try(area.authentication.key.password, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.authentication.key.password, null)
          authentication_message_digest                                   = try(area.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.authentication.type, null) == "message-digest" ? true : null
          authentication_keychain                                         = try(area.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.authentication.type, null) == "keychain" ? true : null
          authentication_keychain_name                                    = try(area.authentication.keychain, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.authentication.keychain, null)
          authentication_null                                             = try(area.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.authentication.type, null) == "null" ? true : null
          ...
          network_non_broadcast                                           = try(area.network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.network, null) == "non-broadcast" ? true : null
          network_point_to_point                                          = try(area.network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.network, null) == "point-to-point" ? true : null
          network_point_to_multipoint                                     = try(area.network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.network, null) == "point-to-multipoint" ? true : null
          cost                                                            = try(area.cost, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.cost, null)
          cost_fallback_anomaly_delay_igp_metric_increment                = try(area.cost_fallback.anomaly_delay.igp_metric_increment, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.cost_fallback.anomaly_delay.igp_metric_increment, null)
          cost_fallback_anomaly_delay_igp_metric_multiplier               = try(area.cost_fallback.anomaly_delay.igp_metric_multiplier, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.cost_fallback.anomaly_delay.igp_metric_multiplier, null)
          cost_fallback_anomaly_delay_igp_metric_value                    = try(area.cost_fallback.anomaly_delay.igp_metric_value, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.cost_fallback.anomaly_delay.igp_metric_value, null)
          cost_fallback_anomaly_delay_igp_metric_disable                  = try(area.cost_fallback.anomaly_delay.igp_metric_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.cost_fallback.anomaly_delay.igp_metric_disable, null)
          cost_fallback_anomaly_delay_te_metric_increment                 = try(area.cost_fallback.anomaly_delay.te_metric_increment, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.cost_fallback.anomaly_delay.te_metric_increment, null)
          cost_fallback_anomaly_delay_te_metric_multiplier                = try(area.cost_fallback.anomaly_delay.te_metric_multiplier, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.cost_fallback.anomaly_delay.te_metric_multiplier, null)
          cost_fallback_anomaly_delay_te_metric_value                     = try(area.cost_fallback.anomaly_delay.te_metric_value, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.cost_fallback.anomaly_delay.te_metric_value, null)
          cost_fallback_anomaly_delay_te_metric_disable                   = try(area.cost_fallback.anomaly_delay.te_metric_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.cost_fallback.anomaly_delay.te_metric_disable, null)
          ...
          flood_reduction_enable                                          = try(area.flood_reduction, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.flood_reduction, null) == "enable" ? true : null
          flood_reduction_disable                                         = try(area.flood_reduction, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.flood_reduction, null) == "disable" ? true : null
          demand_circuit_enable                                           = try(area.demand_circuit, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.demand_circuit, null) == "enable" ? true : null
          demand_circuit_disable                                          = try(area.demand_circuit, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.demand_circuit, null) == "disable" ? true : null
          mtu_ignore_enable                                               = try(area.mtu_ignore, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.mtu_ignore, null) == "enable" ? true : null
          mtu_ignore_disable                                              = try(area.mtu_ignore, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.mtu_ignore, null) == "disable" ? true : null
          database_filter_all_out_enable                                  = try(area.database_filter_all_out, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.database_filter_all_out, null) == "enable" ? true : null
          database_filter_all_out_disable                                 = try(area.database_filter_all_out, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.database_filter_all_out, null) == "disable" ? true : null
          passive_enable                                                  = try(area.passive, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.passive, null) == "enable" ? true : null
          passive_disable                                                 = try(area.passive, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.passive, null) == "disable" ? true : null
          ...
          bfd_fast_detect_strict_mode                                     = try(area.bfd_fast_detect, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.bfd_fast_detect, null) == "strict-mode" ? true : null
          ...
          security_ttl                                                    = try(area.security_ttl, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.security_ttl, null) == "enable" ? true : null
          ...
          security_ttl_disable                                            = try(area.security_ttl, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.security_ttl, null) == "disable" ? true : null
          prefix_suppression                                              = try(area.prefix_suppression, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.prefix_suppression, null) == "enable" ? true : null
          prefix_suppression_disable                                      = try(area.prefix_suppression, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.prefix_suppression, null) == "disable" ? true : null
          ...
          fast_reroute_per_link_use_candidate_only_enable                 = try(area.fast_reroute_per_link.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.fast_reroute_per_link.use_candidate_only, null) == "enable" ? true : null
          fast_reroute_per_link_use_candidate_only_disable                = try(area.fast_reroute_per_link.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.fast_reroute_per_link.use_candidate_only, null) == "disable" ? true : null
          ...
          fast_reroute_per_prefix_use_candidate_only_enable               = try(area.fast_reroute_per_prefix.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.fast_reroute_per_prefix.use_candidate_only, null) == "enable" ? true : null
          fast_reroute_per_prefix_use_candidate_only_disable              = try(area.fast_reroute_per_prefix.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.fast_reroute_per_prefix.use_candidate_only, null) == "disable" ? true : null
          ...
          fast_reroute_per_prefix_ti_lfa_enable                           = try(area.fast_reroute_per_prefix.ti_lfa, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.fast_reroute_per_prefix.ti_lfa, null) == "enable" ? true : null
          fast_reroute_per_prefix_ti_lfa_disable                          = try(area.fast_reroute_per_prefix.ti_lfa, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.fast_reroute_per_prefix.ti_lfa, null) == "disable" ? true : null
          ...
          loopback_stub_network_enable                                    = try(area.loopback_stub_network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.loopback_stub_network, null) == "enable" ? true : null
          loopback_stub_network_disable                                   = try(area.loopback_stub_network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.loopback_stub_network, null) == "disable" ? true : null
          ...
          message_digest_keys = try(length(area.authentication.message_digest_keys) == 0, true) ? null : [for key in area.authentication.message_digest_keys : {
            ...
            md5_encrypted = try(key.password, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.authentication.message_digest_keys.password, null)
          }]
          fast_reroute_per_link_exclude_interfaces = try(length(area.fast_reroute_per_link.exclude_interfaces) == 0, true) ? null : [for iface in area.fast_reroute_per_link.exclude_interfaces : {
            interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.fast_reroute_per_link.exclude_interfaces.name, null)
          }]
          fast_reroute_per_link_lfa_candidate_interfaces = try(length(area.fast_reroute_per_link.lfa_candidate_interfaces) == 0, true) ? null : [for iface in area.fast_reroute_per_link.lfa_candidate_interfaces : {
            interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.fast_reroute_per_link.lfa_candidate_interfaces.name, null)
          }]
          fast_reroute_per_prefix_exclude_interfaces = try(length(area.fast_reroute_per_prefix.exclude_interfaces) == 0, true) ? null : [for iface in area.fast_reroute_per_prefix.exclude_interfaces : {
            interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.fast_reroute_per_prefix.exclude_interfaces.name, null)
          }]
          fast_reroute_per_prefix_lfa_candidate_interfaces = try(length(area.fast_reroute_per_prefix.lfa_candidate_interfaces) == 0, true) ? null : [for iface in area.fast_reroute_per_prefix.lfa_candidate_interfaces : {
            interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.fast_reroute_per_prefix.lfa_candidate_interfaces.name, null)
          }]
          multi_area_interfaces = try(length(area.multi_area_interfaces) == 0, true) ? null : [for mai in area.multi_area_interfaces : {
            interface_name                                                  = try(mai.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.name, null)
            authentication_key_encrypted                                    = try(mai.authentication.key.password, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.authentication.key.password, null)
            authentication_message_digest                                   = try(mai.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.authentication.type, null) == "message-digest" ? true : null
            authentication_keychain                                         = try(mai.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.authentication.type, null) == "keychain" ? true : null
            authentication_keychain_name                                    = try(mai.authentication.keychain, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.authentication.keychain, null)
            authentication_null                                             = try(mai.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.authentication.type, null) == "null" ? true : null
            ...
            cost_fallback                                                   = try(mai.cost_fallback.cost, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.cost_fallback.cost, null)
            cost_fallback_threshold                                         = try(mai.cost_fallback.threshold, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.cost_fallback.threshold, null)
            ...
            mtu_ignore_enable                                               = try(mai.mtu_ignore, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.mtu_ignore, null) == "enable" ? true : null
            mtu_ignore_disable                                              = try(mai.mtu_ignore, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.mtu_ignore, null) == "disable" ? true : null
            database_filter_all_out_enable                                  = try(mai.database_filter_all_out, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.database_filter_all_out, null) == "enable" ? true : null
            database_filter_all_out_disable                                 = try(mai.database_filter_all_out, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.database_filter_all_out, null) == "disable" ? true : null
            ...
            fast_reroute_per_link_use_candidate_only_enable                 = try(mai.fast_reroute_per_link.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.fast_reroute_per_link.use_candidate_only, null) == "enable" ? true : null
            fast_reroute_per_link_use_candidate_only_disable                = try(mai.fast_reroute_per_link.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.fast_reroute_per_link.use_candidate_only, null) == "disable" ? true : null
            ...
            fast_reroute_per_prefix_use_candidate_only_enable               = try(mai.fast_reroute_per_prefix.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.fast_reroute_per_prefix.use_candidate_only, null) == "enable" ? true : null
            fast_reroute_per_prefix_use_candidate_only_disable              = try(mai.fast_reroute_per_prefix.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.fast_reroute_per_prefix.use_candidate_only, null) == "disable" ? true : null
            ...
            fast_reroute_per_prefix_ti_lfa_enable                           = try(mai.fast_reroute_per_prefix.ti_lfa, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.fast_reroute_per_prefix.ti_lfa, null) == "enable" ? true : null
            fast_reroute_per_prefix_ti_lfa_disable                          = try(mai.fast_reroute_per_prefix.ti_lfa, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.fast_reroute_per_prefix.ti_lfa, null) == "disable" ? true : null
            ...
            passive_enable                                                  = try(mai.passive, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.passive, null) == "enable" ? true : null
            passive_disable                                                 = try(mai.passive, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.passive, null) == "disable" ? true : null
            ...
            message_digest_keys = try(length(mai.authentication.message_digest_keys) == 0, true) ? null : [for key in mai.authentication.message_digest_keys : {
              key_id        = try(key.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.authentication.message_digest_keys.id, null)
              md5_encrypted = try(key.password, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.authentication.message_digest_keys.password, null)
            }]
            fast_reroute_per_link_exclude_interfaces = try(length(mai.fast_reroute_per_link.exclude_interfaces) == 0, true) ? null : [for iface in mai.fast_reroute_per_link.exclude_interfaces : {
              interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.fast_reroute_per_link.exclude_interfaces.name, null)
            }]
            fast_reroute_per_link_lfa_candidate_interfaces = try(length(mai.fast_reroute_per_link.lfa_candidate_interfaces) == 0, true) ? null : [for iface in mai.fast_reroute_per_link.lfa_candidate_interfaces : {
              interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.fast_reroute_per_link.lfa_candidate_interfaces.name, null)
            }]
            fast_reroute_per_prefix_exclude_interfaces = try(length(mai.fast_reroute_per_prefix.exclude_interfaces) == 0, true) ? null : [for iface in mai.fast_reroute_per_prefix.exclude_interfaces : {
              interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.fast_reroute_per_prefix.exclude_interfaces.name, null)
            }]
            fast_reroute_per_prefix_lfa_candidate_interfaces = try(length(mai.fast_reroute_per_prefix.lfa_candidate_interfaces) == 0, true) ? null : [for iface in mai.fast_reroute_per_prefix.lfa_candidate_interfaces : {
              interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.fast_reroute_per_prefix.lfa_candidate_interfaces.name, null)
            }]
          }]
          virtual_links = try(length(area.virtual_links) == 0, true) ? null : [for vl in area.virtual_links : {
            ...
            authentication_key_encrypted  = try(vl.authentication.key.password, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.virtual_links.authentication.key.password, null)
            authentication_message_digest = try(vl.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.virtual_links.authentication.type, null) == "message-digest" ? true : null
            authentication_keychain       = try(vl.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.virtual_links.authentication.type, null) == "keychain" ? true : null
            authentication_keychain_name  = try(vl.authentication.keychain, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.virtual_links.authentication.keychain, null)
            authentication_null           = try(vl.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.virtual_links.authentication.type, null) == "null" ? true : null
            message_digest_keys = try(length(vl.authentication.message_digest_keys) == 0, true) ? null : [for key in vl.authentication.message_digest_keys : {
              key_id        = try(key.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.virtual_links.authentication.message_digest_keys.id, null)
              md5_encrypted = try(key.password, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.virtual_links.authentication.message_digest_keys.password, null)
            }]
          }]
        }
      ]
