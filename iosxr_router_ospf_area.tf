    ...
    for device in local.devices : [
      for ospf_process in try(local.device_config[device.name].routing.ospf_processes, []) : [
        for area in try(ospf_process.areas, []) : {
          ...
          authentication_message_digest                                   = try(area.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.authentication.type, null) == "message_digest" ? true : null
          ...
          multi_area_interfaces = try(length(area.multi_area_interfaces) == 0, true) ? null : [for mai in area.multi_area_interfaces : {
            ...
            authentication_message_digest                                   = try(mai.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.multi_area_interfaces.authentication.type, null) == "message_digest" ? true : null
          ...
          virtual_links = try(length(area.virtual_links) == 0, true) ? null : [for vl in area.virtual_links : {
            ...
            authentication_message_digest = try(vl.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.virtual_links.authentication.type, null) == "message_digest" ? true : null
