    ...
    for device in local.devices : [
      for bgp_process in try(local.device_config[device.name].routing.bgp, []) : [
        for neighbor_group in try(bgp_process.neighbor_groups, []) : {
          key                                        = format("%s/%s/%s", device.name, bgp_process.as_number, neighbor_group.name)
          device_name                                = device.name
          as_number                                  = try(bgp_process.as_number, local.defaults.iosxr.devices.configuration.routing.bgp.as_number, null)
          name                                       = try(neighbor_group.name, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.name, null)
          ...
          tcp_mss_value                              = try(neighbor_group.tcp_mss, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.tcp_mss, null)
          ...
          bmp_activate_servers = try(length(neighbor_group.bmp_activate_servers) == 0, true) ? null : [for server in neighbor_group.bmp_activate_servers : {
            server_number = try(server.number, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.bmp_activate_servers.number, null)
            }
          ]
          ...
          keychain_name                                    = try(neighbor_group.keychain, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.keychain, null)
          ...
          local_as_no_prepend                              = try(neighbor_group.local_as_mode, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.local_as_mode, null) == "no-prepend" ? true : null
          local_as_no_prepend_replace_as                   = try(neighbor_group.local_as_mode, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.local_as_mode, null) == "no-prepend-replace-as" ? true : null
          local_as_no_prepend_replace_as_dual_as           = try(neighbor_group.local_as_mode, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.local_as_mode, null) == "no-prepend-replace-as-dual-as" ? true : null
          ...
          receive_buffer_size_read                         = try(neighbor_group.receive_buffer_read_size, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.receive_buffer_read_size, null)
          ...
          send_buffer_size_write                           = try(neighbor_group.send_buffer_write_size, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.send_buffer_write_size, null)
          ...
          log_message_in_size                              = try(neighbor_group.log_message_in, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.log_message_in, null)
          ...
          log_message_out_size                             = try(neighbor_group.log_message_out, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.log_message_out, null)
          ...
          local_address_subnet_mask                        = try(neighbor_group.local_address_subnet_length, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.local_address_subnet_length, null)
          ...
          dscp = try(lookup(local.dscp_map,
            tostring(try(neighbor_group.dscp, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.dscp)),
            tostring(try(neighbor_group.dscp, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.dscp))
            ), null
          )
          precedence = try(lookup(local.precedence_map,
            tostring(try(neighbor_group.precedence, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.precedence)),
            tostring(try(neighbor_group.precedence, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.precedence))
            ), null
          )
          ...
          graceful_restart                                                  = try(neighbor_group.graceful_restart, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_restart, null) == "enable" ? true : null
          graceful_restart_disable                                          = try(neighbor_group.graceful_restart, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_restart, null) == "disable" ? true : null
          ...
          peer_sets = try(length(neighbor_group.peer_sets) == 0, true) ? null : [for peer_set in neighbor_group.peer_sets : {
            peer = try(peer_set.id, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.peer_sets.id, null)
            }
          ]
          ao_key_chain_name                                              = try(neighbor_group.ao_key_chain, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.ao_key_chain, null)
          ...
          graceful_maintenance_activate                                  = try(neighbor_group.graceful_maintenance.activate, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_maintenance.activate, null)
          graceful_maintenance_activate_inheritance_disable              = try(neighbor_group.graceful_maintenance.activate_inheritance_disable, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_maintenance.activate_inheritance_disable, null)
          graceful_maintenance_local_preference                          = try(neighbor_group.graceful_maintenance.local_preference, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_maintenance.local_preference, null)
          graceful_maintenance_local_preference_inheritance_disable      = try(neighbor_group.graceful_maintenance.local_preference_inheritance_disable, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_maintenance.local_preference_inheritance_disable, null)
          graceful_maintenance_as_prepends_number                        = try(neighbor_group.graceful_maintenance.as_prepends, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_maintenance.as_prepends, null)
          graceful_maintenance_as_prepends_inheritance_disable           = try(neighbor_group.graceful_maintenance.as_prepends_inheritance_disable, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_maintenance.as_prepends_inheritance_disable, null)
          graceful_maintenance_bandwidth_aware_percentage_threshold      = try(neighbor_group.graceful_maintenance.bandwidth_aware_percentage_threshold, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_maintenance.bandwidth_aware_percentage_threshold, null)
          graceful_maintenance_bandwidth_aware_percentage_threshold_high = try(neighbor_group.graceful_maintenance.bandwidth_aware_percentage_threshold_high, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_maintenance.bandwidth_aware_percentage_threshold_high, null)
          graceful_maintenance_bandwidth_aware_bandwidth_threshold       = try(neighbor_group.graceful_maintenance.bandwidth_aware_bandwidth_threshold, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_maintenance.bandwidth_aware_bandwidth_threshold, null)
          graceful_maintenance_bandwidth_aware_bandwidth_threshold_high  = try(neighbor_group.graceful_maintenance.bandwidth_aware_bandwidth_threshold_high, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_maintenance.bandwidth_aware_bandwidth_threshold_high, null)
          graceful_maintenance_bandwidth_aware_inheritance_disable       = try(neighbor_group.graceful_maintenance.bandwidth_aware_inheritance_disable, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.graceful_maintenance.bandwidth_aware_inheritance_disable, null)
          address_family = try(length(neighbor_group.address_family) == 0, true) ? null : [for af in neighbor_group.address_family : {
            af_name                                                 = try(af.name, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.name, null)
            ...
            site_of_origin_two_byte_as_number                       = try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin, null) != null ? try(provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).format == "two_byte_as" ? tostring(provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).as_number) : null, null) : null
            site_of_origin_two_byte_as_index                        = try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin, null) != null ? try(provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).format == "two_byte_as" ? provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).assigned_number : null, null) : null
            site_of_origin_four_byte_as_number                      = try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin, null) != null ? try(provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).format == "four_byte_as" ? tostring(provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).as_number) : null, null) : null
            site_of_origin_four_byte_as_index                       = try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin, null) != null ? try(provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).format == "four_byte_as" ? provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).assigned_number : null, null) : null
            site_of_origin_ipv4_address                             = try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin, null) != null ? try(provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).format == "ipv4_address" ? provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).ipv4_address : null, null) : null
            site_of_origin_ipv4_address_index                       = try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin, null) != null ? try(provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).format == "ipv4_address" ? provider::utils::normalize_bgp_rd(try(af.site_of_origin, local.defaults.iosxr.devices.configuration.routing.bgp.neighbor_groups.address_family.site_of_origin)).assigned_number : null, null) : null
