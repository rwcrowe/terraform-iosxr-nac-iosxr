    ...
    for device in local.devices : [
      for policy_map in try(local.device_config[device.name].policy_maps, []) : {
        ...
        classes = try(length(policy_map.classes) == 0, true) ? null : [for class in policy_map.classes : {
          name                                    = try(class.name, local.defaults.iosxr.devices.configuration.policy_maps.classes.name, null)
          type                                    = try(class.type, local.defaults.iosxr.devices.configuration.policy_maps.classes.type, null)
          decapsulate_gre                         = try(class.decapsulate_gre, local.defaults.iosxr.devices.configuration.policy_maps.classes.decapsulate_gre, null)
          drop                                    = try(class.drop, local.defaults.iosxr.devices.configuration.policy_maps.classes.drop, null)
          police_rate_unit                        = try(class.police_rate_unit, local.defaults.iosxr.devices.configuration.policy_maps.classes.police_rate_unit, null)
          police_rate_value                       = try(class.police_rate_value, local.defaults.iosxr.devices.configuration.policy_maps.classes.police_rate_value, null)
          redirect_ipv4_default_route             = try(class.redirect_ipv4.default_route, local.defaults.iosxr.devices.configuration.policy_maps.classes.redirect_ipv4.default_route, null)
          redirect_ipv4_nexthop1_address          = try(class.redirect_ipv4.nexthops[0].address, null)
          redirect_ipv4_nexthop1_vrf              = try(class.redirect_ipv4.nexthops[0].vrf, null)
          redirect_ipv4_nexthop2_address          = try(class.redirect_ipv4.nexthops[1].address, null)
          redirect_ipv4_nexthop2_vrf              = try(class.redirect_ipv4.nexthops[1].vrf, null)
          redirect_ipv4_nexthop3_address          = try(class.redirect_ipv4.nexthops[2].address, null)
          redirect_ipv4_nexthop3_vrf              = try(class.redirect_ipv4.nexthops[2].vrf, null)
          redirect_ipv6_default_route             = try(class.redirect_ipv6.default_route, local.defaults.iosxr.devices.configuration.policy_maps.classes.redirect_ipv6.default_route, null)
          redirect_ipv6_nexthop1_address          = try(class.redirect_ipv6.nexthops[0].address, null)
          redirect_ipv6_nexthop1_vrf              = try(class.redirect_ipv6.nexthops[0].vrf, null)
          redirect_ipv6_nexthop2_address          = try(class.redirect_ipv6.nexthops[1].address, null)
          redirect_ipv6_nexthop2_vrf              = try(class.redirect_ipv6.nexthops[1].vrf, null)
          redirect_ipv6_nexthop3_address          = try(class.redirect_ipv6.nexthops[2].address, null)
          redirect_ipv6_nexthop3_vrf              = try(class.redirect_ipv6.nexthops[2].vrf, null)
          redirect_nexthop_route_target_as_format = try(class.redirect_nexthop.route_target, local.defaults.iosxr.devices.configuration.policy_maps.classes.redirect_nexthop.route_target, null)
          set_dscp                                = try(lookup(local.dscp_map, tostring(try(class.set_dscp, local.defaults.iosxr.devices.configuration.policy_maps.classes.set_dscp)), tostring(try(class.set_dscp, local.defaults.iosxr.devices.configuration.policy_maps.classes.set_dscp))), null)
          set_forward_class                       = try(class.set_forward_class, local.defaults.iosxr.devices.configuration.policy_maps.classes.set_forward_class, null)
        }]
      }
      if try(policy_map.type, local.defaults.iosxr.devices.configuration.policy_maps.type, null) == "pbr"
    ]
  ])
}
...
resource "iosxr_policy_map_pbr" "policy_map_pbr" {
  ...
  lifecycle {
    replace_triggered_by = [terraform_data.policy_map_pbr_replace[each.key]]
  }
...
##### redirect ipv4/ipv6 default-route must be applied together with its nexthops. #####

resource "terraform_data" "policy_map_pbr_replace" {
  for_each = { for policy_map in local.policy_map_pbr : policy_map.key => policy_map }
  input = sha256(jsonencode({
    for class in coalesce(each.value.classes, []) : class.name => {
      redirect_ipv4_default_route = class.redirect_ipv4_default_route
      redirect_ipv6_default_route = class.redirect_ipv6_default_route
    }
  }))
}
