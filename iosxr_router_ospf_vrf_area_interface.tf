        ...
        for vrf in try(ospf_process.vrfs, []) : [
          for area in try(vrf.areas, []) : [
            for interface in try(area.interfaces, []) : {
              ...
              authentication_message_digest                                   = try(interface.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.authentication.type, null) == "message_digest" ? true : null
              ...
              network_non_broadcast                                           = try(interface.network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.network, null) == "non_broadcast" ? true : null
              network_point_to_point                                          = try(interface.network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.network, null) == "point_to_point" ? true : null
              network_point_to_multipoint                                     = try(interface.network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.network, null) == "point_to_multipoint" ? true : null
              ...
              bfd_fast_detect_strict_mode                                     = try(interface.bfd_fast_detect, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.bfd_fast_detect, null) == "strict_mode" ? true : null
