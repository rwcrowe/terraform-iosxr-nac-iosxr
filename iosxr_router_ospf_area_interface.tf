      ...
      for ospf_process in try(local.device_config[device.name].routing.ospf_processes, []) : [
        for area in try(ospf_process.areas, []) : [
          for interface in try(area.interfaces, []) : {
            key                                                             = format("%s/%s/%s/%s", device.name, ospf_process.id, area.id, interface.name)
            ...
            interface_name                                                  = try(interface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.name, null)
            authentication_key_encrypted                                    = try(interface.authentication.key.password, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.authentication.key.password, null)
            authentication_message_digest                                   = try(interface.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.authentication.type, null) == "message-digest" ? true : null
            authentication_keychain                                         = try(interface.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.authentication.type, null) == "keychain" ? true : null
            authentication_keychain_name                                    = try(interface.authentication.keychain, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.authentication.keychain, null)
            authentication_null                                             = try(interface.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.authentication.type, null) == "null" ? true : null
            ...
            network_non_broadcast                                           = try(interface.network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.network, null) == "non-broadcast" ? true : null
            network_point_to_point                                          = try(interface.network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.network, null) == "point-to-point" ? true : null
            network_point_to_multipoint                                     = try(interface.network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.network, null) == "point-to-multipoint" ? true : null
            mpls_ldp_sync                                                   = try(interface.mpls_ldp_sync, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.mpls_ldp_sync, null) == "enable" ? true : null
            mpls_ldp_sync_disable                                           = try(interface.mpls_ldp_sync, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.mpls_ldp_sync, null) == "disable" ? true : null
            cost                                                            = try(interface.cost, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.cost, null)
            cost_fallback                                                   = try(interface.cost_fallback.cost, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.cost_fallback.cost, null)
            cost_fallback_threshold                                         = try(interface.cost_fallback.threshold, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.cost_fallback.threshold, null)
            cost_fallback_anomaly_delay_igp_metric_increment                = try(interface.cost_fallback.anomaly_delay.igp_metric_increment, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.cost_fallback.anomaly_delay.igp_metric_increment, null)
            cost_fallback_anomaly_delay_igp_metric_multiplier               = try(interface.cost_fallback.anomaly_delay.igp_metric_multiplier, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.cost_fallback.anomaly_delay.igp_metric_multiplier, null)
            cost_fallback_anomaly_delay_igp_metric_value                    = try(interface.cost_fallback.anomaly_delay.igp_metric_value, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.cost_fallback.anomaly_delay.igp_metric_value, null)
            cost_fallback_anomaly_delay_igp_metric_disable                  = try(interface.cost_fallback.anomaly_delay.igp_metric_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.cost_fallback.anomaly_delay.igp_metric_disable, null)
            cost_fallback_anomaly_delay_te_metric_increment                 = try(interface.cost_fallback.anomaly_delay.te_metric_increment, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.cost_fallback.anomaly_delay.te_metric_increment, null)
            cost_fallback_anomaly_delay_te_metric_multiplier                = try(interface.cost_fallback.anomaly_delay.te_metric_multiplier, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.cost_fallback.anomaly_delay.te_metric_multiplier, null)
            cost_fallback_anomaly_delay_te_metric_value                     = try(interface.cost_fallback.anomaly_delay.te_metric_value, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.cost_fallback.anomaly_delay.te_metric_value, null)
            cost_fallback_anomaly_delay_te_metric_disable                   = try(interface.cost_fallback.anomaly_delay.te_metric_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.cost_fallback.anomaly_delay.te_metric_disable, null)
            ...
            flood_reduction_enable                                          = try(interface.flood_reduction, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.flood_reduction, null) == "enable" ? true : null
            flood_reduction_disable                                         = try(interface.flood_reduction, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.flood_reduction, null) == "disable" ? true : null
            demand_circuit_enable                                           = try(interface.demand_circuit, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.demand_circuit, null) == "enable" ? true : null
            demand_circuit_disable                                          = try(interface.demand_circuit, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.demand_circuit, null) == "disable" ? true : null
            mtu_ignore_enable                                               = try(interface.mtu_ignore, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.mtu_ignore, null) == "enable" ? true : null
            mtu_ignore_disable                                              = try(interface.mtu_ignore, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.mtu_ignore, null) == "disable" ? true : null
            database_filter_all_out_enable                                  = try(interface.database_filter_all_out, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.database_filter_all_out, null) == "enable" ? true : null
            database_filter_all_out_disable                                 = try(interface.database_filter_all_out, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.database_filter_all_out, null) == "disable" ? true : null
            passive_enable                                                  = try(interface.passive, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.passive, null) == "enable" ? true : null
            passive_disable                                                 = try(interface.passive, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.passive, null) == "disable" ? true : null
            ...
            bfd_fast_detect_strict_mode                                     = try(interface.bfd_fast_detect, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.bfd_fast_detect, null) == "strict-mode" ? true : null
            ...
            security_ttl                                                    = try(interface.security_ttl, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.security_ttl, null) == "enable" ? true : null
            ...
            security_ttl_disable                                            = try(interface.security_ttl, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.security_ttl, null) == "disable" ? true : null
            prefix_suppression                                              = try(interface.prefix_suppression, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_suppression, null) == "enable" ? true : null
            prefix_suppression_disable                                      = try(interface.prefix_suppression, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_suppression, null) == "disable" ? true : null
            ...
            fast_reroute_per_link_use_candidate_only_enable                 = try(interface.fast_reroute_per_link.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.fast_reroute_per_link.use_candidate_only, null) == "enable" ? true : null
            fast_reroute_per_link_use_candidate_only_disable                = try(interface.fast_reroute_per_link.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.fast_reroute_per_link.use_candidate_only, null) == "disable" ? true : null
            ...
            fast_reroute_per_prefix_use_candidate_only_enable               = try(interface.fast_reroute_per_prefix.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.fast_reroute_per_prefix.use_candidate_only, null) == "enable" ? true : null
            fast_reroute_per_prefix_use_candidate_only_disable              = try(interface.fast_reroute_per_prefix.use_candidate_only, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.fast_reroute_per_prefix.use_candidate_only, null) == "disable" ? true : null
            ...
            fast_reroute_per_prefix_ti_lfa_enable                           = try(interface.fast_reroute_per_prefix.ti_lfa, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.fast_reroute_per_prefix.ti_lfa, null) == "enable" ? true : null
            fast_reroute_per_prefix_ti_lfa_disable                          = try(interface.fast_reroute_per_prefix.ti_lfa, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.fast_reroute_per_prefix.ti_lfa, null) == "disable" ? true : null
            ...
            loopback_stub_network_enable                                    = try(interface.loopback_stub_network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.loopback_stub_network, null) == "enable" ? true : null
            loopback_stub_network_disable                                   = try(interface.loopback_stub_network, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.loopback_stub_network, null) == "disable" ? true : null
            ...
            prefix_sid_index                                                = try(interface.prefix_sid.index.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid.index.id, null)
            prefix_sid_index_explicit_null                                  = try(interface.prefix_sid.index.explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid.index.explicit_null, null)
            prefix_sid_index_n_flag_clear                                   = try(interface.prefix_sid.index.n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid.index.n_flag_clear, null)
            prefix_sid_absolute                                             = try(interface.prefix_sid.absolute.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid.absolute.id, null)
            prefix_sid_absolute_explicit_null                               = try(interface.prefix_sid.absolute.explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid.absolute.explicit_null, null)
            prefix_sid_absolute_n_flag_clear                                = try(interface.prefix_sid.absolute.n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid.absolute.n_flag_clear, null)
            prefix_sid_strict_spf_index                                     = try(interface.prefix_sid_strict_spf.index.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_strict_spf.index.id, null)
            prefix_sid_strict_spf_index_explicit_null                       = try(interface.prefix_sid_strict_spf.index.explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_strict_spf.index.explicit_null, null)
            prefix_sid_strict_spf_index_n_flag_clear                        = try(interface.prefix_sid_strict_spf.index.n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_strict_spf.index.n_flag_clear, null)
            prefix_sid_strict_spf_absolute                                  = try(interface.prefix_sid_strict_spf.absolute.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_strict_spf.absolute.id, null)
            prefix_sid_strict_spf_absolute_explicit_null                    = try(interface.prefix_sid_strict_spf.absolute.explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_strict_spf.absolute.explicit_null, null)
            prefix_sid_strict_spf_absolute_n_flag_clear                     = try(interface.prefix_sid_strict_spf.absolute.n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_strict_spf.absolute.n_flag_clear, null)
            segment_routing_forwarding_mpls                                 = try(interface.segment_routing.forwarding, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.segment_routing.forwarding, null) == "mpls" ? true : null
            segment_routing_forwarding_disable                              = try(interface.segment_routing.forwarding, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.segment_routing.forwarding, null) == "disable" ? true : null
            ...
            affinity_flex_algos = try(length(interface.affinity_flex_algos) == 0, true) ? null : [for affinity in interface.affinity_flex_algos : {
              affinity_name = try(affinity.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.affinity_flex_algos.name, null)
            }]
            ...
            message_digest_keys = try(length(interface.authentication.message_digest_keys) == 0, true) ? null : [for key in interface.authentication.message_digest_keys : {
              key_id        = try(key.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.authentication.message_digest_keys.id, null)
              md5_encrypted = try(key.password, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.authentication.message_digest_keys.password, null)
            }]
            fast_reroute_per_link_exclude_interfaces = try(length(interface.fast_reroute_per_link.exclude_interfaces) == 0, true) ? null : [for iface in interface.fast_reroute_per_link.exclude_interfaces : {
              interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.fast_reroute_per_link.exclude_interfaces.name, null)
            }]
            fast_reroute_per_link_lfa_candidate_interfaces = try(length(interface.fast_reroute_per_link.lfa_candidate_interfaces) == 0, true) ? null : [for iface in interface.fast_reroute_per_link.lfa_candidate_interfaces : {
              interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.fast_reroute_per_link.lfa_candidate_interfaces.name, null)
            }]
            fast_reroute_per_prefix_exclude_interfaces = try(length(interface.fast_reroute_per_prefix.exclude_interfaces) == 0, true) ? null : [for iface in interface.fast_reroute_per_prefix.exclude_interfaces : {
              interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.fast_reroute_per_prefix.exclude_interfaces.name, null)
            }]
            fast_reroute_per_prefix_lfa_candidate_interfaces = try(length(interface.fast_reroute_per_prefix.lfa_candidate_interfaces) == 0, true) ? null : [for iface in interface.fast_reroute_per_prefix.lfa_candidate_interfaces : {
              interface_name = try(iface.name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.fast_reroute_per_prefix.lfa_candidate_interfaces.name, null)
            }]
            prefix_sid_algorithms = try(length(interface.prefix_sid_algorithms) == 0, true) ? null : [for algo in interface.prefix_sid_algorithms : {
              ...
              index                  = try(algo.index.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_algorithms.index.id, null)
              index_explicit_null    = try(algo.index.explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_algorithms.index.explicit_null, null)
              index_n_flag_clear     = try(algo.index.n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_algorithms.index.n_flag_clear, null)
              absolute               = try(algo.absolute.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_algorithms.absolute.id, null)
              absolute_explicit_null = try(algo.absolute.explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_algorithms.absolute.explicit_null, null)
              absolute_n_flag_clear  = try(algo.absolute.n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.prefix_sid_algorithms.absolute.n_flag_clear, null)
            }]
            adjacency_sid_indexes = try(length(interface.adjacency_sids.index) == 0, true) ? null : [for idx in interface.adjacency_sids.index : {
              sid_index        = try(idx.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.adjacency_sids.index.id, null)
              protected        = try(idx.protected, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.adjacency_sids.index.protected, null)
              neighbor_address = try(idx.neighbor_address, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.adjacency_sids.index.neighbor_address, null)
            }]
            adjacency_sid_absolutes = try(length(interface.adjacency_sids.absolute) == 0, true) ? null : [for abs in interface.adjacency_sids.absolute : {
              sid_value        = try(abs.id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.adjacency_sids.absolute.id, null)
              protected        = try(abs.protected, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.adjacency_sids.absolute.protected, null)
              neighbor_address = try(abs.neighbor_address, local.defaults.iosxr.devices.configuration.routing.ospf_processes.areas.interfaces.adjacency_sids.absolute.neighbor_address, null)
            }]
          }
        ]
      ]
