      ...
      for ospf_process in try(local.device_config[device.name].routing.ospf_processes, []) : [
        for vrf in try(ospf_process.vrfs, []) : [
          for area in try(vrf.areas, []) : {
            ...
            authentication_message_digest                                   = try(area.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.authentication.type, null) == "message_digest" ? true : null
            ...
            virtual_links = try(length(area.virtual_links) == 0, true) ? null : [for vl in area.virtual_links : {
              ...
              authentication_message_digest = try(vl.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.virtual_links.authentication.type, null) == "message_digest" ? true : null
            ...
            sham_links = try(length(area.sham_links) == 0, true) ? null : [for sl in area.sham_links : {
              ...
              authentication_message_digest = try(sl.authentication.type, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.sham_links.authentication.type, null) == "message_digest" ? true : null
